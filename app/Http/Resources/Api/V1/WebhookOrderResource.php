...
class WebhookOrderResource extends JsonResource
{
    public function toArray($request): array
    {
        ...
        return [
            ...
            'monthly_water_swerage_bill' => $this->monthly_water_swerage_bill,
            'monthly_gas_bill' => $this->monthly_gas_bill,
            'finance_provider'      => $this->finance_provider,
            "appointment_id"        => $this->appointment_id,
            "contact_id"            => $this->contact_id,
            'status'                => $this->status,
            'order_items'           => WebhookOrderItemResource::collection($this->orderItems),
